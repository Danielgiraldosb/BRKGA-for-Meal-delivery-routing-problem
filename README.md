[README.md](https://github.com/user-attachments/files/26470840/README.md)
# BRKGA for Meal Delivery Routing problem Vehicle Routing Problem with Time Windows (MDVRPTW)

This implementation provides two independent BRKGA (Biased Random-Key Genetic Algorithm) metaheuristics for solving the MDRP problem in last-mile delivery scenarios.
